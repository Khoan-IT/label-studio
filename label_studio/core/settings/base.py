...
DATABASES_ALL = {
    DJANGO_DB_POSTGRESQL: {
        ...
        'USER': get_env('POSTGRE_USER', 'jakjdxcyqyckav'),
        'PASSWORD': get_env('POSTGRE_PASSWORD', 'cb49de1aea2d502a7771bb8b0e752fda82e8edac1fad6dc2f5bb513ba728d8be'),
        'NAME': get_env('POSTGRE_NAME', 'd3mc55hl0nl1hc'),
        'HOST': get_env('POSTGRE_HOST', 'ec2-34-231-221-151.compute-1.amazonaws.com'),
...
# LOCAL_FILES_DOCUMENT_ROOT = "E:\\OLLI\\ver3\\data"
LOCAL_FILES_DOCUMENT_ROOT = get_env('LOCAL_FILES_DOCUMENT_ROOT', default="/media/wicii/DDH/OLLI/Label-Studio/data")
