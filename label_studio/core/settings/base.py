...
DATABASES_ALL = {
    DJANGO_DB_POSTGRESQL: {
        ...
        'USER': get_env('POSTGRE_USER', 'duckhoan'),
        'PASSWORD': get_env('POSTGRE_PASSWORD', '25032001'),
        'NAME': get_env('POSTGRE_NAME', 'olli-2'),
...
# LOCAL_FILES_DOCUMENT_ROOT = get_env('LOCAL_FILES_DOCUMENT_ROOT', default="E:\\OLLI\\ver3\\data")

print("HHHHHHHH",LOCAL_FILES_DOCUMENT_ROOT, LOCAL_FILES_SERVING_ENABLED)
